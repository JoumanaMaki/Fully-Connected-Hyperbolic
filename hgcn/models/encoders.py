...
class HGCN(Encoder):
    ...
    def __init__(self, c, args):
        ...
        linear_variant = getattr(args, 'linear_variant', 'standard')
        hgc_layers = []
        for i in range(len(dims) - 1):
            ...
            hgc_layers.append(
                    hyp_layers.HyperbolicGraphConvolution(
                            self.manifold, in_dim, out_dim, c_in, c_out, args.dropout, act, args.bias, args.use_att, args.local_agg, linear_variant
                    )
            )
